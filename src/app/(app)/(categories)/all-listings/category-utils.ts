...
export const CATEGORY_MAPPING = {
  'healthcare-medical': {
    ...
    metaDescription: 'Discover trusted Healthcare & Medical services in Kenya. Connect with general practitioners, dentists, hospitals, pharmacies, and mental health professionals for comprehensive expat healthcare.',
    icon: '🏥',
  ...
  'immigration-legal': {
    ...
    metaDescription: 'Get expert Immigration & Legal services in Kenya. Find immigration lawyers, visa consultants, legal counsel, and tax advisors to navigate Kenyan regulations and documentation.',
    icon: '⚖️',
  ...
  'housing-relocation': {
    ...
    metaDescription: 'Discover comprehensive Housing & Relocation services in Kenya. Find rental properties, real estate agents, moving companies, and relocation support for a smooth transition.',
    icon: '🏠',
  ...
  'education-learning': {
    ...
    metaDescription: 'Explore Education & Learning options in Kenya. Find international schools, language courses, tutoring services, universities, and preschools for comprehensive educational support.',
    icon: '📚',
  ...
  'finance-insurance': {
    ...
    metaDescription: 'Access comprehensive Finance & Insurance services in Kenya. Find banks, financial advisors, insurance providers, money transfer services, and mortgage options for expats.',
    icon: '💰',
  ...
  'transportation-mobility': {
    ...
    metaDescription: 'Discover Transportation & Mobility solutions in Kenya. Find car rental, driving schools, vehicle sales, auto repair, and public transportation options for convenient travel.',
    icon: '🚗',
  ...
  'jobs-career': {
    ...
    metaDescription: 'Advance your Jobs & Career in Kenya with recruitment agencies, career coaching, networking groups, co-working spaces, and professional resume services.',
    icon: '💼',
  ...
  'home-services': {
    ...
    metaDescription: 'Access reliable Home Services in Kenya for utilities setup, cleaning, repairs, pest control, and furniture assembly. Maintain your home with professional providers.',
    icon: '🔨',
  ...
  'food-dining': {
    ...
    metaDescription: 'Explore Food & Dining options in Kenya including restaurants, grocery stores, food delivery, catering services, and specialty food markets for diverse culinary experiences.',
    icon: '🍽️',
  ...
  'community-lifestyle': {
    ...
    metaDescription: 'Build your Community & Lifestyle in Kenya through expat groups, cultural centers, sports clubs, social activities, and organized events for meaningful connections.',
    icon: '👥',
