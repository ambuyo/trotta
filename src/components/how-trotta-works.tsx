...
const HowTrottaWorks: FC<Props> = ({
  className,
  data = DEMO_DATA,
  heading = (
    <>
      How <span data-slot="italic">Trotta</span> works
    </>
  ),
  subHeading = 'Start your Kenya move with confidence. Find verified services, access practical guides, and connect with expats who understand your journey.',
}) => {
  return (
