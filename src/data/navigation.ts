...
export function getListingsMenuItems() {
  const listingsMenuItems: {
  ...
  }[] = [
    {
      ...
      children: [
        { title: 'Cultural Centers', href: '/all-listings' },
        { title: 'Event Organizers', href: '/all-listings' },
        { title: 'Expat Communities', href: '/all-listings' },
        { title: 'Social Clubs', href: '/all-listings' },
        { title: 'Sports & Fitness', href: '/all-listings' },
      ],
    },
    {
      title: 'Education & Learning',
      children: [
        { title: 'International Schools', href: '/all-listings' },
        { title: 'Language Schools', href: '/all-listings' },
        { title: 'Preschools & Daycare', href: '/all-listings' },
        { title: 'Tutoring Services', href: '/all-listings' },
        { title: 'Universities', href: '/all-listings' },
      ],
    },
    {
      title: 'Finance & Insurance',
      children: [
        { title: 'Banks', href: '/all-listings' },
        { title: 'Financial Advisors', href: '/all-listings' },
        { title: 'Insurance Companies', href: '/all-listings' },
        { title: 'Money Transfer Services', href: '/all-listings' },
        { title: 'Mortgage Services', href: '/all-listings' },
      ],
    },
    {
      title: 'Food & Dining',
      children: [
        { title: 'Catering Services', href: '/all-listings' },
        { title: 'Food Delivery', href: '/all-listings' },
        { title: 'Grocery Stores', href: '/all-listings' },
        { title: 'Restaurants & Cafes', href: '/all-listings' },
        { title: 'Specialty Food Stores', href: '/all-listings' },
      ],
    },
    {
      title: 'Healthcare & Medical',
      children: [
        { title: 'Dentists & Dental Care', href: '/all-listings' },
        { title: 'General Practitioners', href: '/all-listings' },
        { title: 'Hospitals & Emergency', href: '/all-listings' },
        { title: 'Mental Health & Therapy', href: '/all-listings' },
        { title: 'Pharmacies', href: '/all-listings' },
      ],
    },
    {
      title: 'Home Services',
      children: [
        { title: 'Cleaning Services', href: '/all-listings' },
        { title: 'Furniture Assembly', href: '/all-listings' },
        { title: 'Pest Control', href: '/all-listings' },
        { title: 'Repair Services', href: '/all-listings' },
        { title: 'Utilities Setup', href: '/all-listings' },
      ],
    },
    {
      title: 'Housing & Relocation',
      children: [
        { title: 'Moving & Storage', href: '/all-listings' },
        { title: 'Property Companies', href: '/all-listings' },
        { title: 'Real Estate Agents', href: '/all-listings' },
        { title: 'Relocation Services', href: '/all-listings' },
        { title: 'Rental Properties', href: '/all-listings' },
      ],
    },
    {
      title: 'Immigration & Legal',
      children: [
        { title: 'General Counsel', href: '/all-listings' },
        { title: 'Immigration Lawyers', href: '/all-listings' },
        { title: 'Tax Consultants', href: '/all-listings' },
        { title: 'Translation & Notary', href: '/all-listings' },
        { title: 'Visa Consultants', href: '/all-listings' },
      ],
    },
    {
      title: 'Jobs & Career',
      children: [
        { title: 'Career Coaches', href: '/all-listings' },
        { title: 'Co-working Spaces', href: '/all-listings' },
        { title: 'Networking Groups', href: '/all-listings' },
        { title: 'Recruitment Agencies', href: '/all-listings' },
        { title: 'Resume Services', href: '/all-listings' },
      ],
    },
    {
      title: 'Transport',
      children: [
        { title: 'Auto Repairs', href: '/all-listings' },
        { title: 'Car Rental', href: '/all-listings' },
        { title: 'Driving Schools', href: '/all-listings' },
        { title: 'Public Transportation', href: '/all-listings' },
        { title: 'Vehicle Sales', href: '/all-listings' },
      ],
    },
  ]
